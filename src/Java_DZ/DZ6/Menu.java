...
public class Menu {
    ...
    public static List<String> paramChoiceMenu() {
        return new ArrayList<>(Arrays.asList("Производитель","Модель","Размер монитора","Дискретный видео адаптер",
                "Количество ядер","Частота ЦП","RAM","HDD/SSD\n", "Вывести результат фильтрации"));
    }
